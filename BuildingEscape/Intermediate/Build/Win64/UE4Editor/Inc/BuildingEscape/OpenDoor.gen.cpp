...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UOpenDoor()
	{
		...
		if (!OuterClass)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PresurePlate_MetaData[] = {
				{ "Category", "OpenDoor" },
				{ "ModuleRelativePath", "OpenDoor.h" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_PresurePlate = { UE4CodeGen_Private::EPropertyClass::Object, "PresurePlate", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000001, 1, nullptr, STRUCT_OFFSET(UOpenDoor, PresurePlate), Z_Construct_UClass_ATriggerVolume_NoRegister, METADATA_PARAMS(NewProp_PresurePlate_MetaData, ARRAY_COUNT(NewProp_PresurePlate_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PresurePlate,
	...
	IMPLEMENT_CLASS(UOpenDoor, 3916330410);
